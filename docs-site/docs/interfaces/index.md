...
| An **AGWPE / AGW Packet Engine** (or Direwolf in AGW mode) to drive your radios | `AGW` | — | [AGWPE](agwpe.md) |
| An **internet link to another node** (RF can't reach it) | `AXUDP`, `AXIP` or `AXTCP` | — | [AXIP / AXUDP / AXTCP](axip-axudp-axtcp.md) |
| A **VARA** (FM/HF) or **ARDOP** modem reached over TCP | (see page) | — | [VARA and ARDOP](vara-ardop.md) |
