...
| An AGW Packet Engine / Direwolf as a packet engine | `AGW` | n/a  [AGWPE](../interfaces/agwpe.md) |
| An internet link to a partner node (raw IP) | `AXIP` | n/a  [AXIP / AXUDP / AXTCP](../interfaces/axip-axudp-axtcp.md) |
| An internet link to a partner node (over UDP) | `AXUDP` | n/a  [AXIP / AXUDP / AXTCP](../interfaces/axip-axudp-axtcp.md) |
| An internet link through NAT/firewalls (over TCP) | `AXTCP` | n/a  [AXIP / AXUDP / AXTCP](../interfaces/axip-axudp-axtcp.md) |
